/*
  ...
  - You are about to drop the column `contact` on the `Palvelu` table. All the data in the column will be lost.
  - You are about to drop the column `contact` on the `Tarve` table. All the data in the column will be lost.
...
INSERT INTO "new_Palvelu" ("description", "id", "title", "userId") SELECT "description", "id", "title", "userId" FROM "Palvelu";
DROP TABLE "Palvelu";
